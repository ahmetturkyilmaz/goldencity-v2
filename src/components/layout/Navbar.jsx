        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <Link to="/" className="flex items-center">
              <svg width="30" height="35" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="15" cy="20" r="10" stroke="#0682ff" className="dark:stroke-primary-400"/>
                  <circle cx="15" cy="20" r="6" stroke="#0682ff" strokeWidth="3" className="dark:stroke-primary-400"/>
              </svg>  
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            ...
            <button
              ...
              className="p-2 rounded-lg text-secondary-600 dark:text-secondary-300 hover:bg-secondary-100 dark:hover:bg-secondary-700 transition-all duration-200"
        ...
        {isOpen && (
          <div className="md:hidden border-t border-secondary-200 dark:border-secondary-700">
            <div className="pt-2 pb-3 space-y-1">
              ...
              <button
                className="block w-full text-left px-3 py-2 text-base font-medium text-white bg-primary-600 hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 transition-colors duration-200"
                onClick={() => setIsOpen(false)}
              >
                Connect
              </button>
